...
// Last modified by I Putu Jaya Adi Pranata (officialputuid)
// fb|ig|twitter|gplus|line|github|behance|medium? officialputuid
...
const questionTools = [{
  ...
  choices: [
    ...
    "► Like & Comment Followers Target  [USING ITTYW/DELAY]",
    "► Follow & Like Followers Target   [USING ITTYW/DELAY]",
...
const main = async() => {
  ...
  try {
    ...
    switch (toolChoise) {
      ...
      case "► Like & Comment Followers Target  [USING ITTYW/DELAY]":
        const lnktauto = require('./tools/lnktauto.js');
        await unfollnotfollback();
        break;

      case "► Follow & Like Followers Target   [USING ITTYW/DELAY]":
...
console.log(chalk `{bold.green
  ...
  Ξ UPLOAD : 20/10/2019 [20.10 WITA]
